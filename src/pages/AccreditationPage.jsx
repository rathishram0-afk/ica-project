  ...
  return (
    <div className="w-full bg-white text-slate-800">
      ...
      <div className="max-w-6xl mx-auto px-6 lg:px-12 py-14 space-y-20">
          ...
          <div className="grid lg:grid-cols-2 gap-10 items-center">
            <div className="space-y-5">
              ...
              <button
                ...
                className="inline-flex items-center gap-2 px-7 py-3.5 rounded-full bg-[#0B2D6B] text-white text-xs font-bold uppercase tracking-wider hover:bg-[#071d47] transition-all shadow-sm hover:shadow-md transform hover:-translate-y-0.5"
              >
                Apply for Accreditation <ArrowRight size={13} />
              </button>
            </div>

            {/* Visual Stats Card */}
            <div className="bg-gradient-to-br from-[#0B2D6B] to-[#16489C] rounded-3xl p-8 text-white relative overflow-hidden shadow-xl">
        ...
        <section>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {benefits.map((b, i) => {
              const Icon = b.icon;
              return (
                <div key={i} className="bg-[#F8F9FB] rounded-3xl p-6 border border-slate-200/80 shadow-xs hover:border-[#C8A24A]/50 hover:-translate-y-1 transition-all duration-200">
                  <div className="w-11 h-11 rounded-2xl bg-[#0B2D6B] text-[#C8A24A] flex items-center justify-center mb-4">
                    <Icon size={20} />
                  </div>
        ...
        {/* CTA */}
        <section className="bg-gradient-to-r from-[#0B2D6B] to-[#16489C] rounded-3xl p-8 sm:p-12 text-white text-center">
